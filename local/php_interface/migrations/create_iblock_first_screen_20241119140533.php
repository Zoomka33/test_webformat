...
class create_iblock_first_screen_20241119140533 extends Version
{
  ...
  'IBLOCK_TYPE_ID' => 'main_page',
  'LID' => 
  array (
    0 => 's1',
  ),
  'CODE' => 'first_screen',
  'API_CODE' => 'FirstScreen',
  'REST_ON' => 'Y',
  'NAME' => 'Первый экран',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Кнопка "Подобрать программу"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'BUTTON_TEXT',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Якорь кнопки "Подобрать программу"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'BUTTON_LINK',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_ICON' => 'Значок',
    'PROPERTY_BUTTON_TEXT' => 'Кнопка "Подобрать программу"',
    'PROPERTY_BUTTON_LINK' => 'Якорь кнопки "Подобрать программу"',
