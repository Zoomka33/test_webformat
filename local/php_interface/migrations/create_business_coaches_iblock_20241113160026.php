...
class create_business_coaches_iblock_20241113160026 extends Version
{
    protected $author = "admin";

    protected $description = "Создание инфоблока бизнес-тренеров";
  ...
  'IBLOCK_TYPE_ID' => 'general_blocks',
  'LID' => 
  array (
    0 => 's1',
  ),
  'CODE' => 'business-coaches',
  'API_CODE' => 'BusinessCoaches',
  'REST_ON' => 'Y',
  'NAME' => 'Бизнес-трененры',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/general_blocks/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/general_blocks/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/general_blocks/list.php?SECTION_ID=#SECTION_ID#',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    'PROPERTY_COACH_DESCRIPTION' => 'Описание',
      'PROPERTY_JOB_TITLE' => 'Должность',
  ),
  'SEO|edit14' => 
  array (
  ...
  'current_view' => 'default',
    ...
    {
        $helper = $this->getHelperManager();
        $id = $helper->Iblock()->getIblockId('business-coaches');
        $helper->Iblock()->deleteIblock($id);
    }
}
